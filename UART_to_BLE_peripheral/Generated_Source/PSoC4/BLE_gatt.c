    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x42u] = {
    /* Device Name */
    (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r', (uint8)'_', (uint8)'S', (uint8)'l',
    (uint8)'a', (uint8)'v', (uint8)'e',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0014u, (void *)&cyBle_attValues[26] }, /* Server_UART_Tx_data */
    ...
    { 0x0014u, (void *)&cyBle_attValues[46] }, /* Server_UART_Rx_data */
};
