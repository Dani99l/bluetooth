/* ========================================
 *
 * Prototypes to read temperature, humidity and pressure from BME280 Sensor
...
/*****************************************************************************/
    ...
    //Commands
#define I2CSlaveAddress 0x76
#define TEMP280 0xF6
#define HUM280 0xFD
#define PRESS280 0xF7
#define PRESSTEMP 0xF5

#define OSS 0x03 //Oversampling setting for ultra high resolution
long UT280, UH280, UP280; //Variables to store uncompensated temperature and pressure data
int temp280, hum280, press280;  //Variables to store the true temperature, pressure and altitude data
