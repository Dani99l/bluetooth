...
#define TEMP_COM 0XE3
#define HUM_COM 0XE5
#define OSS 0x03 //Oversampling setting for ultra high resolution
long UT, UH; //Variables to store uncompensated temperature and pressure data
long htutemp, htuhum;  //Variables to store the true temperature, pressure and altitude data
//Commands.
